			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 login-sec">
						<h2 class="text-center">THỰC PHẨM TKT</h2>
									...
									<div class="inner-container">
										<div class="box" id="loginBox">
											...
											<form>
												...
												<div class="col-md-12 mb-4">
													<div class="form-outline">
														<label class="form-label" for="psw">Mật khẩu</label> <input
												...
												<div class="d-grid gap-2">
													...
													<input class="btn btn-primary" type="submit"
														value="Đăng nhập" /> <a class="btn btn-success"
						...
						<div class="copy-text">
							Created with <i class="fa fa-heart"></i> by <a
								href="http://facebook.com/leebask.kp">Lê Khánh,</a> <a
								href="https://www.facebook.com/minhtan0802">Minh Tân,</a> <a
								href="https://www.facebook.com/phuoctaine">Phước Tài</a>
						</div>
					</div>
					<div class="col-md-8 banner-sec">
						<img src="resources/images/logo.jpg" style="width: 730px;" />
					</div>
		</section>
	</form:form>
</body>
